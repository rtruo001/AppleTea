...
In this example. 
The client tells the server a user logged in.
The server updates the count of users, and sends a message to EVERY client that a user has joined
The client side pushes the user into the list of users.
