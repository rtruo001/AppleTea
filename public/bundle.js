...
},{"./invariant":3,"_process":35}],5:[function(require,module,exports){
"use strict";
...
},{"./emptyFunction":1,"_process":35}],8:[function(require,module,exports){
'use strict';
...
},{"./reactProdInvariant":29,"_process":35,"fbjs/lib/invariant":3}],11:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactChildren":12,"./ReactClass":13,"./ReactComponent":14,"./ReactDOMFactories":17,"./ReactElement":18,"./ReactElementValidator":19,"./ReactPropTypes":23,"./ReactVersion":24,"./onlyChild":28,"_process":35,"fbjs/lib/warning":7,"object-assign":8}],12:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactComponent":14,"./ReactElement":18,"./ReactNoopUpdateQueue":20,"./ReactPropTypeLocationNames":21,"./ReactPropTypeLocations":22,"./reactProdInvariant":29,"_process":35,"fbjs/lib/emptyObject":2,"fbjs/lib/invariant":3,"fbjs/lib/keyMirror":4,"fbjs/lib/keyOf":5,"fbjs/lib/warning":7,"object-assign":8}],14:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactNoopUpdateQueue":20,"./canDefineProperty":25,"./reactProdInvariant":29,"_process":35,"fbjs/lib/emptyObject":2,"fbjs/lib/invariant":3,"fbjs/lib/warning":7}],15:[function(require,module,exports){
(function (process){
/**
...
},{"./ReactCurrentOwner":16,"./reactProdInvariant":29,"_process":35,"fbjs/lib/invariant":3,"fbjs/lib/warning":7}],16:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":18,"./ReactElementValidator":19,"_process":35,"fbjs/lib/mapObject":6}],18:[function(require,module,exports){
(function (process){
/**
...
},{"./ReactCurrentOwner":16,"./canDefineProperty":25,"_process":35,"fbjs/lib/warning":7,"object-assign":8}],19:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-present, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactComponentTreeDevtool":15,"./ReactCurrentOwner":16,"./ReactElement":18,"./ReactPropTypeLocations":22,"./canDefineProperty":25,"./checkReactTypeSpec":26,"./getIteratorFn":27,"_process":35,"fbjs/lib/warning":7}],20:[function(require,module,exports){
(function (process){
/**
...
},{"_process":35,"fbjs/lib/warning":7}],21:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactComponentTreeDevtool":15,"./ReactPropTypeLocationNames":21,"./reactProdInvariant":29,"_process":35,"fbjs/lib/invariant":3,"fbjs/lib/warning":7}],27:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":18,"./reactProdInvariant":29,"_process":35,"fbjs/lib/invariant":3}],29:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./KeyEscapeUtils":9,"./ReactCurrentOwner":16,"./ReactElement":18,"./getIteratorFn":27,"./reactProdInvariant":29,"_process":35,"fbjs/lib/invariant":3,"fbjs/lib/warning":7}],31:[function(require,module,exports){
'use strict';
...
ReactDOM.render(React.createElement(SearchComponent, null), document.getElementById('search'));
ReactDOM.render(React.createElement(QueueComponent, null), document.getElementById('queue'));

},{"./../views/Queue.jsx":33,"./../views/Search.jsx":34}],33:[function(require,module,exports){
(function (global){
'use strict';
...
var QueueEntries = React.createClass({
  displayName: 'QueueEntries',

  render: function render() {
    return React.createElement(
      'div',
      { id: 'queue-list-entry-' + this.props.pos, className: 'queue-list-entry' },
      React.createElement(Thumbnail, { thumbnail: this.props.thumbnail }),
...
var Queue = React.createClass({
  ...
  componentDidMount: function componentDidMount() {
    ...
    global.mediaClickedAddToQueue = function (mediaEntry) {
      var queueListWithNewMediaEntry = _this.state.queueList.concat(mediaEntry);
      _this.setState({ queueList: queueListWithNewMediaEntry });
    };
  },
  render: function render() {
    var queueEntries = [];
    ...
    for (var i = 0; i < this.state.queueList.length; ++i) {
      ...
      queueEntries.push(React.createElement(QueueEntries, { key: queueEntry.videoId, pos: i, videoId: queueEntry.videoId, thumbnail: queueEntry.thumbnail, title: queueEntry.title }));
    }

    return React.createElement(
      'div',
      null,
      React.createElement(TopOfQueueList, { currentTop: "Halsey" }),
      queueEntries
    );
  }
});
...
var MediaEntry = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      'div',
      { id: 'media-list-entry-' + this.props.pos, className: 'media-list-entry' },
      React.createElement(Thumbnail, { thumbnail: this.props.thumbnail }),
      React.createElement(Title, { title: this.props.title }),
      React.createElement(
        'button',
        { id: 'media-entry-button-' + this.props.pos, className: 'media-entry-button', onClick: this.handleClick },
        'Add To Queue'
      )
    );
  }
  ...
  render: function render() {
    ...
    if (json !== "" && json !== undefined) {
      ...
      for (var i = 0; i < json.items.length; ++i) {
        ...
        mediaEntries.push(React.createElement(MediaEntry, {
