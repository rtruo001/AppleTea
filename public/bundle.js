    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(QueueTitle, { queueTitle: "Chill Ass Music" }),
          React.createElement(PlaylistLength, { playlistLength: this.state.queueList.length }),
          React.createElement(AddedMediaLength, { addedMediaLength: this.state.queueList.length })
        ),
        React.createElement(
          'div',
